...
### <a id="platform.noConflict" href="https://github.com/bestiejs/platform.js/blob/master/platform.js#L498" title="View in source">`platform.noConflict()`</a>
...
### <a id="platform.parse" href="https://github.com/bestiejs/platform.js/blob/master/platform.js#L221" title="View in source">`platform.parse([ua = navigator.userAgent])`</a>
...
### <a id="platform.toString" href="https://github.com/bestiejs/platform.js/blob/master/platform.js#L510" title="View in source">`platform.toString()`</a>
